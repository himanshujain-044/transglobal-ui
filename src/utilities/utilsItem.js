...
export const offersCard = [
  {
    title: "Integrated Refinery Solutions",
    description:
      "Our cutting-edge refineries are designed to optimize hydrogen production alongside traditional refining processes.",
  },
  {
    title: "Hydrogen Packages",
    description:
      "We provide tailored hydrogen solutions that cater to diverse industrial needs.",
  },
  {
